    ...
    <div class="modal-body">
        <form class="form-horizontal" method="post" name="basic_validate">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="resourceDownloadCountDetail" type="text" name="resourceTypeDetail" disabled="disabled"/>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label">资源浏览数:</label>
                <div class="controls">
                    <input id="resourceBrowseCountDetail" type="text" name="resourceTypeDetail" disabled="disabled"/>
                </div>
            </div>
            <div class="control-group">
