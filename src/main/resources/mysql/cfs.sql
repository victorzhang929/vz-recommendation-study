...
CREATE TABLE `message` (
  `id` char(32) NOT NULL,
  `msg_content` text,
  `receive_user_id` char(32) NOT NULL,
  `send_user_id` char(32) NOT NULL,
...
CREATE TABLE `resource_score` (
  `useri_d` char(32) NOT NULL,
  `resource_id` char(32) NOT NULL,
  `rating` tinyint(1) DEFAULT NULL COMMENT '5分制',
  `rating_time` datetime NOT NULL,
  PRIMARY KEY (`useri_d`,`resource_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
